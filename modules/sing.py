...
def get_current_note(volume_thresh=0.01, printOut=False):
    ...
    while True:
        ...
        print(current_pitch.nameWithOctave)
        if printOut and previous_pitch_midi != current_pitch.midi:
            #print(current_pitch)
            print(current_pitch.midi)
            previous_pitch_midi = current_pitch.midi
