...
- A *hotword detection* module using a Python 3 library of [Snowboy](https://github.com/Kitt-AI/snowboy/tree/master/lib) built with [Swig](http://www.swig.org/)
- A *speech-to-text* module using the Google Speech-to-Text API
- A *music player* module using the Youtube Data API and VLC for on-device offline playlists, Youtube music and radio stations
